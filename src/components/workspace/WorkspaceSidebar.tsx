...
export default function WorkspaceSidebar({ username, email, role }: Props) {
   ...
   const [collapsed, setCollapsed] = useState(() => {
      ...
      return localStorage.getItem("ws_sidebar_collapsed") === "1";
   });
   ...
   return (
      <aside className={`ws-sidebar ${collapsed ? "collapsed" : ""}`}>
         ...
         <div className="ws-sidebar-brand">
            ...
            <span className="ws-sidebar-brand-mini">vx</span>
            <div className="ws-sidebar-brand-meta">
         ...
         <nav className="ws-sidebar-nav">
            ...
            >
               ...
               <span className="ws-nav-label">โปรเจกต์ทั้งหมด</span>
            </Link>
            ...
            {isAdmin && (
               <>
                  ...
                  >
                     ...
                     <span className="ws-nav-label">พนักงานทั้งหมด</span>
                  </Link>
               </>
            )}
            ...
            >
               ...
               <span className="ws-nav-label">โปรไฟล์ & Portfolio</span>
            </Link>
            ...
            >
               ...
               <span className="ws-nav-label">ดูเว็บสาธารณะ</span>
            </Link>
         </nav>
